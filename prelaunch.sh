...
echo "We reccomend creating a gravitysync user on the remote system - would you like to do this?"
if [ readYesNo ]; then
    ...
    echo "The remote system is configured as reccomended"
else
    echo "Would you like to use the root account? NOT RECCOMENDED!"
    if [ !readYesNo ]; then
